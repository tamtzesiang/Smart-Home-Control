...
#ifndef PROJECT2ADEMO_H_
#define PROJECT2ADEMO_H_
...
{
PINSEL_CFG_Type PinCfg;
//Initialize Rotary1 GPIO pin connect
PinCfg.Funcnum = 1;
PinCfg.OpenDrain = 0;
PinCfg.Pinmode = 0;
PinCfg.Portnum = 0;
PinCfg.Pinnum = 24;
PINSEL_ConfigPin(&PinCfg);
//Initialize Rotary2 GPIO pin connect
PinCfg.Funcnum = 1;
PinCfg.OpenDrain = 0;
PinCfg.Pinmode = 0;
PinCfg.Portnum = 0;
...
//darkness ^= 1;		//bitwise XOR to toggle?
//oled_fillRect(0,44,96,64,OLED_COLOR_BLACK);		//clearing the light on/off display on OLED
//oled_fillRect(0,30,96,40,OLED_COLOR_BLACK);		//clearing the temp display on OLED

#endif /* PROJECT2ADEMO_H_ */
